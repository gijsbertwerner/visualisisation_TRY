...
I will randomly selected 75 tips/rows to higlight some combinations of options. The reason I am not immediately going into the full 350k is that rendering a figure of that size can actually takes a while (almost half an hour, on my quite fast computer), so I want to have a bit of an idea first of where we are heading. 
