...
#Let's make some small dataset for run_17.5k code.
set.seed(01865)
run_17.5k_dat<-dat[sample(nrow(dat),size=17500),]
run_17.5k_tree<-drop.tip(tree,
                     tree$tip.label[!tree$tip.label %in% run_17.5k_dat$match_col])
plot.phylo(run_17.5k_tree,type="f",cex = 0.15)
run_17.5k_tree
...
summary(run_17.5k_dat$Log.Number.of.Traits)
#Create vector
run_17.5k_trait_num_log<-run_17.5k_dat$Log.Number.of.Traits
names(run_17.5k_trait_num_log)<-run_17.5k_dat$match_col
#For ease of plotting, order vector same order as in tree
run_17.5k_trait_num_log<-run_17.5k_trait_num_log[match(run_17.5k_tree$tip.label,names(run_17.5k_trait_num_log))]

system.time(
  run_17.5k_tree_rec_num_log<-anc.recon(trait_data = run_17.5k_trait_num_log,tree = run_17.5k_tree)
)
save(run_17.5k_tree_rec_num_log,file = "./Models/run_17.5k_tree_rec_num_log")

#Plot the results
plot.phylo(run_17.5k_tree,type="fan",cex=0.5,
           tip.color = viridis(100)[cut(run_17.5k_trait_num_log,breaks=100)],
...
nodelabels(col=viridis(100)[cut(run_17.5k_tree_rec_num_log[,1],breaks=100)],pch=16) #Probably leave this out of the eventual one. 
gc()

###Quantiative reconstruction, absolute numbers
summary(run_17.5k_dat$Number.of.Traits)
#Create vector
run_17.5k_trait_num<-run_17.5k_dat$Number.of.Traits
names(run_17.5k_trait_num)<-run_17.5k_dat$match_col
#For ease of plotting, order vector same order as in tree
run_17.5k_trait_num<-run_17.5k_trait_num[match(run_17.5k_tree$tip.label,names(run_17.5k_trait_num))]

system.time(
  run_17.5k_tree_rec_num<-anc.recon(trait_data = run_17.5k_trait_num,tree = run_17.5k_tree)
)
save(run_17.5k_tree_rec_num,file = "./Models/run_17.5k_tree_rec_num")

#Plot the results
plot.phylo(run_17.5k_tree,type="fan",cex=0.5,
           tip.color = viridis(100)[cut(run_17.5k_trait_num,breaks=100)],
...
nodelabels(col=viridis(100)[cut(run_17.5k_tree_rec_num[,1],breaks=100)],pch=16) #Probably leave this out of the eventual one. 
gc()

#Bins reconstructed, ordinal
table(run_17.5k_dat$trait_num_bins)
#Create vector
run_17.5k_trait_num_bins<-run_17.5k_dat$trait_num_bins
names(run_17.5k_trait_num_bins)<-run_17.5k_dat$match_col
#For ease of plotting, order vector same order as in tree
run_17.5k_trait_num_bins<-run_17.5k_trait_num_bins[match(run_17.5k_tree$tip.label,names(run_17.5k_trait_num_bins))]
table(run_17.5k_trait_num_bins)

####Model as an (ordered) character 

#ARD
mapped_run_17.5k_trait_num_bins<-map_to_state_space(raw_states = run_17.5k_trait_num_bins)
system.time(
...
#Plot with pies
plot.phylo(run_17.5k_tree,type="f",cex=0.25,
           tip.color = c("gray90","#fecc5c","#fd8d3c","#f03b20","#bd0026")[run_17.5k_trait_num_bins])
nodelabels(pie = run_17.5k_tree_trait_num_bins_ARD$ancestral_likelihoods,piecol = c("gray90","#fecc5c","#fd8d3c","#f03b20","#bd0026"),cex=0.25)

#Plot with colours
ASR_run_17.5k_tree_trait_num_bins_ARD_vec<-apply(run_17.5k_tree_trait_num_bins_ARD$ancestral_likelihoods,1,which.max)
names(ASR_run_17.5k_tree_trait_num_bins_ARD_vec)<-1:run_17.5k_tree$Nnode+Ntip(run_17.5k_tree)
plot.phylo(run_17.5k_tree,type="f",cex=0.25,
           tip.color = c("gray90","#fecc5c","#fd8d3c","#f03b20","#bd0026")[run_17.5k_trait_num_bins],
           edge.color = c("gray90","#fecc5c","#fd8d3c","#f03b20","#bd0026")[ASR_run_17.5k_tree_trait_num_bins_ARD_vec[match(run_17.5k_tree$edge[,1],names(ASR_run_17.5k_tree_trait_num_bins_ARD_vec))]])
...
plot.phylo(run_17.5k_tree,type="f",cex=0.25,
           tip.color = c("gray90","#fecc5c","#fd8d3c","#f03b20","#bd0026")[run_17.5k_trait_num_bins])
nodelabels(pie = run_17.5k_tree_trait_num_bins_SRD$ancestral_likelihoods,piecol = c("gray90","#fecc5c","#fd8d3c","#f03b20","#bd0026"),cex=0.25)

#Plot with colours
ASR_run_17.5k_tree_trait_num_bins_SRD_vec<-apply(run_17.5k_tree_trait_num_bins_SRD$ancestral_likelihoods,1,which.max)
names(ASR_run_17.5k_tree_trait_num_bins_SRD_vec)<-1:run_17.5k_tree$Nnode+Ntip(run_17.5k_tree)
plot.phylo(run_17.5k_tree,type="f",cex=0.25,
           tip.color = c("gray90","#fecc5c","#fd8d3c","#f03b20","#bd0026")[run_17.5k_trait_num_bins],
           edge.color = c("gray90","#fecc5c","#fd8d3c","#f03b20","#bd0026")[ASR_run_17.5k_tree_trait_num_bins_SRD_vec[match(run_17.5k_tree$edge[,1],names(ASR_run_17.5k_tree_trait_num_bins_SRD_vec))]])


#####And growth form
table(run_17.5k_dat$GIFT_PlantGrowthForm)
#Create vector
run_17.5k_gf<-run_17.5k_dat$GIFT_PlantGrowthForm
names(run_17.5k_gf)<-run_17.5k_dat$match_col
#For ease of plotting, order vector same order as in tree
run_17.5k_gf<-run_17.5k_gf[match(run_17.5k_tree$tip.label,names(run_17.5k_gf))]
table(run_17.5k_gf)

##Select the data matrix containint the tip priors
run_17.5k_gf_priors<-run_17.5k_dat %>% select(match_col,state1_herb,state2_shrub,state3_tree)
rownames(run_17.5k_gf_priors)<-run_17.5k_gf_priors$match_col
run_17.5k_gf_priors<-run_17.5k_gf_priors[match(run_17.5k_tree$tip.label,run_17.5k_gf_priors$match_col),]
run_17.5k_gf_priors<-as.matrix(run_17.5k_gf_priors[,2:4])
head(run_17.5k_gf_priors)
...
#Plot with nodes
plot.phylo(run_17.5k_tree,type="f",cex=0.25)
nodelabels(pie = run_17.5k_tree_gf_ARD$ancestral_likelihoods,piecol = c("lightgreen","darkgreen","brown"),cex=0.25)

ASR_run_17.5k_tree_gf_ARD_vec<-apply(run_17.5k_tree_gf_ARD$ancestral_likelihoods,1,which.max)
names(ASR_run_17.5k_tree_gf_ARD_vec)<-1:run_17.5k_tree$Nnode+Ntip(run_17.5k_tree)
#Plot with colours
plot.phylo(run_17.5k_tree,type="f",cex=0.25,
...
#Plot with nodes
plot.phylo(run_17.5k_tree,type="f",cex=0.25)
nodelabels(pie = run_17.5k_tree_gf_SRD$ancestral_likelihoods,piecol = c("lightgreen","darkgreen","brown"),cex=0.25)

ASR_run_17.5k_tree_gf_SRD_vec<-apply(run_17.5k_tree_gf_SRD$ancestral_likelihoods,1,which.max)
names(ASR_run_17.5k_tree_gf_SRD_vec)<-1:run_17.5k_tree$Nnode+Ntip(run_17.5k_tree)
#Plot with colours
plot.phylo(run_17.5k_tree,type="f",cex=0.25,
...
names(herb_anc_vec)<-colnames(run_17.5k_gf_priors)
herb_anc_vec
system.time(
...
#Plot with nodes
plot.phylo(run_17.5k_tree,type="f",cex=0.25)
nodelabels(pie = run_17.5k_tree_gf_SRD_herb_anc$ancestral_likelihoods,piecol = c("lightgreen","darkgreen","brown"),cex=0.25)

ASR_run_17.5k_tree_gf_SRD_herb_anc_vec<-apply(run_17.5k_tree_gf_SRD_herb_anc$ancestral_likelihoods,1,which.max)
names(ASR_run_17.5k_tree_gf_SRD_herb_anc_vec)<-1:run_17.5k_tree$Nnode+Ntip(run_17.5k_tree)
#Plot with colours
plot.phylo(run_17.5k_tree,type="f",cex=0.25,
           edge.color = c("lightgreen","darkgreen","brown")[ASR_run_17.5k_tree_gf_SRD_herb_anc_vec[match(run_17.5k_tree$edge[,1],names(ASR_run_17.5k_tree_gf_SRD_herb_anc_vec))]])
gc()
...
#Generate baseplot
names(run_17.5k_dat)
run_17.5k_dat_plotting_traits <- run_17.5k_dat %>% select(trait_num_bins,
                                                  Leaf.Area,
                                                  SLA,
...
head(run_17.5k_dat_plotting_traits)
names(run_17.5k_dat_plotting_traits)[1]<-"Presence"
names(run_17.5k_dat_plotting_traits)[4]<-"Leaf.N"
names(run_17.5k_dat_plotting_traits)[7]<-"SSD"
names(run_17.5k_dat_plotting_traits)[8]<-"All_Diaz"
...
##Plot baseplot
Sys.time()
pdf(file="./Figures/run_17.5k_base_plot.pdf",width = 8.2,height = 8.2)
...
Sys.time()
pdf(file="./Figures/run_17.5k_trait_num_log_ASR.pdf",width = 8.2,height = 8.2)
trait.plot(tree = run_17.5k_tree,dat = run_17.5k_dat_plotting_traits,cols = list(Presence=c("gray90","#fecc5c","#fd8d3c","#f03b20","#bd0026"),
                                                                         Leaf.Area=c("gray90","#8dd3c7"),
                                                                         SLA=c("gray90","#bebada"),
                                                                         Leaf.N=c("gray90","#fb8072"),
...
Sys.time()
pdf(file="./Figures/run_17.5k_trait_asbolute_num_ASR.pdf",width = 8.2,height = 8.2)
trait.plot(tree = run_17.5k_tree,dat = run_17.5k_dat_plotting_traits,cols = list(Presence=c("gray90","#fecc5c","#fd8d3c","#f03b20","#bd0026"),
                                                                         Leaf.Area=c("gray90","#8dd3c7"),
                                                                         SLA=c("gray90","#bebada"),
                                                                         Leaf.N=c("gray90","#fb8072"),
...
Sys.time()
pdf(file="./Figures/run_17.5k_trait_num_bins_ASR_ARD.pdf",width = 8.2,height = 8.2)
trait.plot(tree = run_17.5k_tree,dat = run_17.5k_dat_plotting_traits,cols = list(Presence=c("gray90","#fecc5c","#fd8d3c","#f03b20","#bd0026"),
                                                                         Leaf.Area=c("gray90","#8dd3c7"),
                                                                         SLA=c("gray90","#bebada"),
                                                                         Leaf.N=c("gray90","#fb8072"),
...
Sys.time()
pdf(file="./Figures/run_17.5k_trait_num_bins_ASR_SRD.pdf",width = 8.2,height = 8.2)
trait.plot(tree = run_17.5k_tree,dat = run_17.5k_dat_plotting_traits,cols = list(Presence=c("gray90","#fecc5c","#fd8d3c","#f03b20","#bd0026"),
                                                                         Leaf.Area=c("gray90","#8dd3c7"),
                                                                         SLA=c("gray90","#bebada"),
                                                                         Leaf.N=c("gray90","#fb8072"),
...
Sys.time()
pdf(file="./Figures/run_17.5k_gf_ASR_ARD.pdf",width = 8.2,height = 8.2)
trait.plot(tree = run_17.5k_tree,dat = run_17.5k_dat_plotting_traits,cols = list(Presence=c("gray90","#fecc5c","#fd8d3c","#f03b20","#bd0026"),
                                                                         Leaf.Area=c("gray90","#8dd3c7"),
                                                                         SLA=c("gray90","#bebada"),
                                                                         Leaf.N=c("gray90","#fb8072"),
...
#Baseplot with growth forms
Sys.time()
pdf(file="./Figures/run_17.5k_gf_ASR_SRD.pdf",width = 8.2,height = 8.2)
trait.plot(tree = run_17.5k_tree,dat = run_17.5k_dat_plotting_traits,cols = list(Presence=c("gray90","#fecc5c","#fd8d3c","#f03b20","#bd0026"),
                                                                         Leaf.Area=c("gray90","#8dd3c7"),
                                                                         SLA=c("gray90","#bebada"),
                                                                         Leaf.N=c("gray90","#fb8072"),
...
#Baseplot with growth forms
Sys.time()
pdf(file="./Figures/run_17.5k_gf_ASR_SRD_herc_anc.pdf",width = 8.2,height = 8.2)
trait.plot(tree = run_17.5k_tree,dat = run_17.5k_dat_plotting_traits,cols = list(Presence=c("gray90","#fecc5c","#fd8d3c","#f03b20","#bd0026"),
                                                                         Leaf.Area=c("gray90","#8dd3c7"),
                                                                         SLA=c("gray90","#bebada"),
                                                                         Leaf.N=c("gray90","#fb8072"),
