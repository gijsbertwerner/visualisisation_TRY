...
system.time(
  run_87.5k_tree_trait_num_bins_ARD<-
    asr_mk_model(tree = run_87.5k_tree,Nstates = 5,tip_states = mapped_run_87.5k_trait_num_bins$mapped_states,
                 rate_model = "ARD",include_ancestral_likelihoods = T,reroot = T,Nrun_87.5ks = 24,Nthreads = 6)
)
...
system.time(
  run_87.5k_tree_trait_num_bins_SRD<-
    asr_mk_model(tree = run_87.5k_tree,Nstates = 5,tip_states = mapped_run_87.5k_trait_num_bins$mapped_states,
                 rate_model = "SRD",include_ancestral_likelihoods = T,reroot = T,Nrun_87.5ks = 24,Nthreads = 6)
)
